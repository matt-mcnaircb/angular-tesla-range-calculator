...
// NUMBER_CONTROL_ACCESSOR constant to allow us to use the "TeslaCountryComponent" as
// a custom provider to the component and enforce the ControlValueAccesssor interface
